    ...
    $.ajax({
        ...
        $("#5DFbtn").on('click', function() {
            ...
            $.ajax({
                ...
                var printDay1Temp = ($("<p>").text("Temperature: " + day1Temp));
                ...
                var printDay2Temp = ($("<p>").text("Temperature: " + day2Temp));
                ...
                var printDay3Temp = ($("<p>").text("Temperature: " + day3Temp));
                ...
                var printDay4Temp = ($("<p>").text("Temperature: " + day4Temp));
                ...
                var printDay5Temp = ($("<p>").text("Temperature: " + day5Temp));
